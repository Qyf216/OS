...
int kern_init(void) {
    ...
    80200026:	158000ef          	jal	ra,8020017e <cons_init>
    ...
    80200042:	14c000ef          	jal	ra,8020018e <idt_init>
    ...
    8020004a:	13e000ef          	jal	ra,80200188 <intr_enable>
...
static void cputch(int c, int *cnt) {
    ...
    cons_putc(c);
    80200058:	128000ef          	jal	ra,80200180 <cons_putc>
    (*cnt)++;
...
int cprintf(const char *fmt, ...) {
    ...
    vprintfmt((void *)cputch, &cnt, fmt, ap);
    80200094:	59e000ef          	jal	ra,80200632 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
void print_kerninfo(void) {
    ...
    802000a6:	9b650513          	addi	a0,a0,-1610 # 80200a58 <etext+0x28>
void print_kerninfo(void) {
    ...
    80200126:	9d650513          	addi	a0,a0,-1578 # 80200af8 <etext+0xc8>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200146:	089000ef          	jal	ra,802009ce <sbi_set_timer>
    cprintf("++ setup timer interrupts\n");
    8020014a:	00001517          	auipc	a0,0x1
    8020014e:	9de50513          	addi	a0,a0,-1570 # 80200b28 <etext+0xf8>
    ticks = 0;
    80200152:	00004797          	auipc	a5,0x4
    80200156:	ea07bf23          	sd	zero,-322(a5) # 80204010 <ticks>
    cprintf("++ setup timer interrupts\n");
    8020015a:	f11ff0ef          	jal	ra,8020006a <cprintf>
    8020015e:	ffff                	0xffff
    80200160:	ffff                	0xffff
    __asm__ volatile("mret");
    80200162:	30200073          	mret
    __asm__ volatile("ebreak");
    80200166:	9002                	ebreak
}
    80200168:	60a2                	ld	ra,8(sp)
    8020016a:	0141                	addi	sp,sp,16
    8020016c:	8082                	ret

000000008020016e <clock_set_next_event>:
    __asm__ __volatile__("rdtime %0" : "=r"(n));
    8020016e:	c0102573          	rdtime	a0
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    80200172:	67e1                	lui	a5,0x18
    80200174:	6a078793          	addi	a5,a5,1696 # 186a0 <kern_entry-0x801e7960>
    80200178:	953e                	add	a0,a0,a5
    8020017a:	0550006f          	j	802009ce <sbi_set_timer>

000000008020017e <cons_init>:
...
0000000080200180 <cons_putc>:

/* cons_putc - print a single character @c to console devices */
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    80200180:	0ff57513          	zext.b	a0,a0
    80200184:	0310006f          	j	802009b4 <sbi_console_putchar>

0000000080200188 <intr_enable>:
#include <intr.h>
#include <riscv.h>

/* intr_enable - enable irq interrupt */
void intr_enable(void) { set_csr(sstatus, SSTATUS_SIE); }
    80200188:	100167f3          	csrrsi	a5,sstatus,2
    8020018c:	8082                	ret

000000008020018e <idt_init>:
 */
void idt_init(void) {
    ...
    8020018e:	14005073          	csrwi	sscratch,0
    /* Set the exception vector address */
    write_csr(stvec, &__alltraps);
    80200192:	00000797          	auipc	a5,0x0
    80200196:	37e78793          	addi	a5,a5,894 # 80200510 <__alltraps>
    8020019a:	10579073          	csrw	stvec,a5
}
    8020019e:	8082                	ret

00000000802001a0 <print_regs>:
...
void print_regs(struct pushregs *gpr) {
    cprintf("  zero     0x%08x\n", gpr->zero);
    802001a0:	610c                	ld	a1,0(a0)
void print_regs(struct pushregs *gpr) {
    802001a2:	1141                	addi	sp,sp,-16
    802001a4:	e022                	sd	s0,0(sp)
    802001a6:	842a                	mv	s0,a0
    cprintf("  zero     0x%08x\n", gpr->zero);
    802001a8:	00001517          	auipc	a0,0x1
    802001ac:	9a050513          	addi	a0,a0,-1632 # 80200b48 <etext+0x118>
void print_regs(struct pushregs *gpr) {
    802001b0:	e406                	sd	ra,8(sp)
    cprintf("  zero     0x%08x\n", gpr->zero);
    802001b2:	eb9ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  ra       0x%08x\n", gpr->ra);
    802001b6:	640c                	ld	a1,8(s0)
    802001b8:	00001517          	auipc	a0,0x1
    802001bc:	9a850513          	addi	a0,a0,-1624 # 80200b60 <etext+0x130>
    802001c0:	eabff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  sp       0x%08x\n", gpr->sp);
    802001c4:	680c                	ld	a1,16(s0)
    802001c6:	00001517          	auipc	a0,0x1
    802001ca:	9b250513          	addi	a0,a0,-1614 # 80200b78 <etext+0x148>
    802001ce:	e9dff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  gp       0x%08x\n", gpr->gp);
    802001d2:	6c0c                	ld	a1,24(s0)
    802001d4:	00001517          	auipc	a0,0x1
    802001d8:	9bc50513          	addi	a0,a0,-1604 # 80200b90 <etext+0x160>
    802001dc:	e8fff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  tp       0x%08x\n", gpr->tp);
    802001e0:	700c                	ld	a1,32(s0)
    802001e2:	00001517          	auipc	a0,0x1
    802001e6:	9c650513          	addi	a0,a0,-1594 # 80200ba8 <etext+0x178>
    802001ea:	e81ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t0       0x%08x\n", gpr->t0);
    802001ee:	740c                	ld	a1,40(s0)
    802001f0:	00001517          	auipc	a0,0x1
    802001f4:	9d050513          	addi	a0,a0,-1584 # 80200bc0 <etext+0x190>
    802001f8:	e73ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t1       0x%08x\n", gpr->t1);
    802001fc:	780c                	ld	a1,48(s0)
    802001fe:	00001517          	auipc	a0,0x1
    80200202:	9da50513          	addi	a0,a0,-1574 # 80200bd8 <etext+0x1a8>
    80200206:	e65ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t2       0x%08x\n", gpr->t2);
    8020020a:	7c0c                	ld	a1,56(s0)
    8020020c:	00001517          	auipc	a0,0x1
    80200210:	9e450513          	addi	a0,a0,-1564 # 80200bf0 <etext+0x1c0>
    80200214:	e57ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s0       0x%08x\n", gpr->s0);
    80200218:	602c                	ld	a1,64(s0)
    8020021a:	00001517          	auipc	a0,0x1
    8020021e:	9ee50513          	addi	a0,a0,-1554 # 80200c08 <etext+0x1d8>
    80200222:	e49ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s1       0x%08x\n", gpr->s1);
    80200226:	642c                	ld	a1,72(s0)
    80200228:	00001517          	auipc	a0,0x1
    8020022c:	9f850513          	addi	a0,a0,-1544 # 80200c20 <etext+0x1f0>
    80200230:	e3bff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a0       0x%08x\n", gpr->a0);
    80200234:	682c                	ld	a1,80(s0)
    80200236:	00001517          	auipc	a0,0x1
    8020023a:	a0250513          	addi	a0,a0,-1534 # 80200c38 <etext+0x208>
    8020023e:	e2dff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a1       0x%08x\n", gpr->a1);
    80200242:	6c2c                	ld	a1,88(s0)
    80200244:	00001517          	auipc	a0,0x1
    80200248:	a0c50513          	addi	a0,a0,-1524 # 80200c50 <etext+0x220>
    8020024c:	e1fff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a2       0x%08x\n", gpr->a2);
    80200250:	702c                	ld	a1,96(s0)
    80200252:	00001517          	auipc	a0,0x1
    80200256:	a1650513          	addi	a0,a0,-1514 # 80200c68 <etext+0x238>
    8020025a:	e11ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a3       0x%08x\n", gpr->a3);
    8020025e:	742c                	ld	a1,104(s0)
    80200260:	00001517          	auipc	a0,0x1
    80200264:	a2050513          	addi	a0,a0,-1504 # 80200c80 <etext+0x250>
    80200268:	e03ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a4       0x%08x\n", gpr->a4);
    8020026c:	782c                	ld	a1,112(s0)
    8020026e:	00001517          	auipc	a0,0x1
    80200272:	a2a50513          	addi	a0,a0,-1494 # 80200c98 <etext+0x268>
    80200276:	df5ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a5       0x%08x\n", gpr->a5);
    8020027a:	7c2c                	ld	a1,120(s0)
    8020027c:	00001517          	auipc	a0,0x1
    80200280:	a3450513          	addi	a0,a0,-1484 # 80200cb0 <etext+0x280>
    80200284:	de7ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a6       0x%08x\n", gpr->a6);
    80200288:	604c                	ld	a1,128(s0)
    8020028a:	00001517          	auipc	a0,0x1
    8020028e:	a3e50513          	addi	a0,a0,-1474 # 80200cc8 <etext+0x298>
    80200292:	dd9ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  a7       0x%08x\n", gpr->a7);
    80200296:	644c                	ld	a1,136(s0)
    80200298:	00001517          	auipc	a0,0x1
    8020029c:	a4850513          	addi	a0,a0,-1464 # 80200ce0 <etext+0x2b0>
    802002a0:	dcbff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s2       0x%08x\n", gpr->s2);
    802002a4:	684c                	ld	a1,144(s0)
    802002a6:	00001517          	auipc	a0,0x1
    802002aa:	a5250513          	addi	a0,a0,-1454 # 80200cf8 <etext+0x2c8>
    802002ae:	dbdff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s3       0x%08x\n", gpr->s3);
    802002b2:	6c4c                	ld	a1,152(s0)
    802002b4:	00001517          	auipc	a0,0x1
    802002b8:	a5c50513          	addi	a0,a0,-1444 # 80200d10 <etext+0x2e0>
    802002bc:	dafff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s4       0x%08x\n", gpr->s4);
    802002c0:	704c                	ld	a1,160(s0)
    802002c2:	00001517          	auipc	a0,0x1
    802002c6:	a6650513          	addi	a0,a0,-1434 # 80200d28 <etext+0x2f8>
    802002ca:	da1ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s5       0x%08x\n", gpr->s5);
    802002ce:	744c                	ld	a1,168(s0)
    802002d0:	00001517          	auipc	a0,0x1
    802002d4:	a7050513          	addi	a0,a0,-1424 # 80200d40 <etext+0x310>
    802002d8:	d93ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s6       0x%08x\n", gpr->s6);
    802002dc:	784c                	ld	a1,176(s0)
    802002de:	00001517          	auipc	a0,0x1
    802002e2:	a7a50513          	addi	a0,a0,-1414 # 80200d58 <etext+0x328>
    802002e6:	d85ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s7       0x%08x\n", gpr->s7);
    802002ea:	7c4c                	ld	a1,184(s0)
    802002ec:	00001517          	auipc	a0,0x1
    802002f0:	a8450513          	addi	a0,a0,-1404 # 80200d70 <etext+0x340>
    802002f4:	d77ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s8       0x%08x\n", gpr->s8);
    802002f8:	606c                	ld	a1,192(s0)
    802002fa:	00001517          	auipc	a0,0x1
    802002fe:	a8e50513          	addi	a0,a0,-1394 # 80200d88 <etext+0x358>
    80200302:	d69ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
    80200306:	646c                	ld	a1,200(s0)
    80200308:	00001517          	auipc	a0,0x1
    8020030c:	a9850513          	addi	a0,a0,-1384 # 80200da0 <etext+0x370>
    80200310:	d5bff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s10      0x%08x\n", gpr->s10);
    80200314:	686c                	ld	a1,208(s0)
    80200316:	00001517          	auipc	a0,0x1
    8020031a:	aa250513          	addi	a0,a0,-1374 # 80200db8 <etext+0x388>
    8020031e:	d4dff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  s11      0x%08x\n", gpr->s11);
    80200322:	6c6c                	ld	a1,216(s0)
    80200324:	00001517          	auipc	a0,0x1
    80200328:	aac50513          	addi	a0,a0,-1364 # 80200dd0 <etext+0x3a0>
    8020032c:	d3fff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t3       0x%08x\n", gpr->t3);
    80200330:	706c                	ld	a1,224(s0)
    80200332:	00001517          	auipc	a0,0x1
    80200336:	ab650513          	addi	a0,a0,-1354 # 80200de8 <etext+0x3b8>
    8020033a:	d31ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t4       0x%08x\n", gpr->t4);
    8020033e:	746c                	ld	a1,232(s0)
    80200340:	00001517          	auipc	a0,0x1
    80200344:	ac050513          	addi	a0,a0,-1344 # 80200e00 <etext+0x3d0>
    80200348:	d23ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t5       0x%08x\n", gpr->t5);
    8020034c:	786c                	ld	a1,240(s0)
    8020034e:	00001517          	auipc	a0,0x1
    80200352:	aca50513          	addi	a0,a0,-1334 # 80200e18 <etext+0x3e8>
    80200356:	d15ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t6       0x%08x\n", gpr->t6);
    8020035a:	7c6c                	ld	a1,248(s0)
}
    8020035c:	6402                	ld	s0,0(sp)
    8020035e:	60a2                	ld	ra,8(sp)
    cprintf("  t6       0x%08x\n", gpr->t6);
    80200360:	00001517          	auipc	a0,0x1
    80200364:	ad050513          	addi	a0,a0,-1328 # 80200e30 <etext+0x400>
}
    80200368:	0141                	addi	sp,sp,16
    cprintf("  t6       0x%08x\n", gpr->t6);
    8020036a:	b301                	j	8020006a <cprintf>
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200378:	ad450513          	addi	a0,a0,-1324 # 80200e48 <etext+0x418>
void print_trapframe(struct trapframe *tf) {
    8020037c:	e406                	sd	ra,8(sp)
    cprintf("trapframe at %p\n", tf);
    8020037e:	cedff0ef          	jal	ra,8020006a <cprintf>
    print_regs(&tf->gpr);
    80200382:	8522                	mv	a0,s0
    80200384:	e1dff0ef          	jal	ra,802001a0 <print_regs>
    cprintf("  status   0x%08x\n", tf->status);
    80200388:	10043583          	ld	a1,256(s0)
    8020038c:	00001517          	auipc	a0,0x1
    80200390:	ad450513          	addi	a0,a0,-1324 # 80200e60 <etext+0x430>
    80200394:	cd7ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
    80200398:	10843583          	ld	a1,264(s0)
    8020039c:	00001517          	auipc	a0,0x1
    802003a0:	adc50513          	addi	a0,a0,-1316 # 80200e78 <etext+0x448>
    802003a4:	cc7ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
    802003a8:	11043583          	ld	a1,272(s0)
    802003ac:	00001517          	auipc	a0,0x1
    802003b0:	ae450513          	addi	a0,a0,-1308 # 80200e90 <etext+0x460>
    802003b4:	cb7ff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  cause    0x%08x\n", tf->cause);
    ...
    802003c4:	ae850513          	addi	a0,a0,-1304 # 80200ea8 <etext+0x478>
}
    802003c8:	0141                	addi	sp,sp,16
    cprintf("  cause    0x%08x\n", tf->cause);
    802003ca:	b145                	j	8020006a <cprintf>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003d2:	0786                	slli	a5,a5,0x1
    802003d4:	8385                	srli	a5,a5,0x1
    802003d6:	08f76163          	bltu	a4,a5,80200458 <interrupt_handler+0x8c>
    802003da:	00001717          	auipc	a4,0x1
    802003de:	b9670713          	addi	a4,a4,-1130 # 80200f70 <etext+0x540>
    ...
    802003f0:	b3450513          	addi	a0,a0,-1228 # 80200f20 <etext+0x4f0>
    802003f4:	b99d                	j	8020006a <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003f6:	00001517          	auipc	a0,0x1
    802003fa:	b0a50513          	addi	a0,a0,-1270 # 80200f00 <etext+0x4d0>
    802003fe:	b1b5                	j	8020006a <cprintf>
            cprintf("User software interrupt\n");
    80200400:	00001517          	auipc	a0,0x1
    80200404:	ac050513          	addi	a0,a0,-1344 # 80200ec0 <etext+0x490>
    80200408:	b18d                	j	8020006a <cprintf>
            cprintf("Supervisor software interrupt\n");
    8020040a:	00001517          	auipc	a0,0x1
    8020040e:	ad650513          	addi	a0,a0,-1322 # 80200ee0 <etext+0x4b0>
    80200412:	b9a1                	j	8020006a <cprintf>
void interrupt_handler(struct trapframe *tf) {
    ...
    8020041a:	d55ff0ef          	jal	ra,8020016e <clock_set_next_event>
            if (++ticks % TICK_NUM == 0) {
    ...
    80200430:	bec40413          	addi	s0,s0,-1044 # 80204018 <printnum>
    80200434:	0785                	addi	a5,a5,1
    80200436:	02e7f733          	remu	a4,a5,a4
    8020043a:	e29c                	sd	a5,0(a3)
    8020043c:	cf19                	beqz	a4,8020045a <interrupt_handler+0x8e>
                print_ticks();
                printnum++;
            }
            if(printnum==10) {sbi_shutdown();}
    8020043e:	6018                	ld	a4,0(s0)
    80200440:	47a9                	li	a5,10
    80200442:	02f70863          	beq	a4,a5,80200472 <interrupt_handler+0xa6>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200452:	b0250513          	addi	a0,a0,-1278 # 80200f50 <etext+0x520>
    80200456:	b911                	j	8020006a <cprintf>
            print_trapframe(tf);
    80200458:	bf11                	j	8020036c <print_trapframe>
    cprintf("%d ticks\n", TICK_NUM);
    8020045a:	06400593          	li	a1,100
    8020045e:	00001517          	auipc	a0,0x1
    80200462:	ae250513          	addi	a0,a0,-1310 # 80200f40 <etext+0x510>
    80200466:	c05ff0ef          	jal	ra,8020006a <cprintf>
                printnum++;
    8020046a:	601c                	ld	a5,0(s0)
    8020046c:	0785                	addi	a5,a5,1
    8020046e:	e01c                	sd	a5,0(s0)
    80200470:	b7f9                	j	8020043e <interrupt_handler+0x72>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    80200496:	10853583          	ld	a1,264(a0)
    8020049a:	00001517          	auipc	a0,0x1
    8020049e:	b0650513          	addi	a0,a0,-1274 # 80200fa0 <etext+0x570>
    ...
    802004ae:	bbdff0ef          	jal	ra,8020006a <cprintf>
            tf->epc+=4;
    ...
    802004d0:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004d2:	bd69                	j	8020036c <print_trapframe>
            cprintf("ebreak caught at 0x%x\n",tf->epc);
    802004d4:	10853583          	ld	a1,264(a0)
    802004d8:	00001517          	auipc	a0,0x1
    802004dc:	b1850513          	addi	a0,a0,-1256 # 80200ff0 <etext+0x5c0>
    802004e0:	b8bff0ef          	jal	ra,8020006a <cprintf>
            cprintf("exception type: breakpoint\n");
    802004e4:	00001517          	auipc	a0,0x1
    802004e8:	b2450513          	addi	a0,a0,-1244 # 80201008 <etext+0x5d8>
    802004ec:	b7fff0ef          	jal	ra,8020006a <cprintf>
            tf->epc+=4;
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    8020050a:	bf85                	j	8020047a <exception_handler>
        interrupt_handler(tf);
    8020050c:	b5c1                	j	802003cc <interrupt_handler>
	...
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200604:	a2878793          	addi	a5,a5,-1496 # 80201028 <etext+0x5f8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200660:	a00a8a93          	addi	s5,s5,-1536 # 8020105c <etext+0x62c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200668:	bd4b8b93          	addi	s7,s7,-1068 # 80201238 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008be:	79e60613          	addi	a2,a2,1950 # 80201058 <etext+0x628>
    ...
    802008d0:	77c60613          	addi	a2,a2,1916 # 80201048 <etext+0x618>
    ...
    802008e2:	76240413          	addi	s0,s0,1890 # 80201040 <etext+0x610>
    ...
    8020096c:	6d840413          	addi	s0,s0,1752 # 80201040 <etext+0x610>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200982:	6c3a0a13          	addi	s4,s4,1731 # 80201041 <etext+0x611>
