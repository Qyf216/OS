...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020042c:	02f6e063          	bltu	a3,a5,8020044c <interrupt_handler+0x8e>
		cprintf("100 ticks\n");  
		num++;  
		ticks = 0; 
	    }
    ...
    80200434:	02e7ea63          	bltu	a5,a4,80200468 <interrupt_handler+0xaa>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200450:	a6c50513          	addi	a0,a0,-1428 # 80200eb8 <etext+0x514>
    80200454:	c17ff0ef          	jal	ra,8020006a <cprintf>
		num++;  
