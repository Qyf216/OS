...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200178:	0570006f          	j	802009ce <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200182:	0330006f          	j	802009b4 <sbi_console_putchar>
...
void idt_init(void) {
    ...
    80200194:	38078793          	addi	a5,a5,896 # 80200510 <__alltraps>
...
void print_regs(struct pushregs *gpr) {
    ...
    802001aa:	9a250513          	addi	a0,a0,-1630 # 80200b48 <etext+0x118>
void print_regs(struct pushregs *gpr) {
    ...
    80200362:	ad250513          	addi	a0,a0,-1326 # 80200e30 <etext+0x400>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200376:	ad650513          	addi	a0,a0,-1322 # 80200e48 <etext+0x418>
void print_trapframe(struct trapframe *tf) {
    ...
    802003c2:	aea50513          	addi	a0,a0,-1302 # 80200ea8 <etext+0x478>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003d4:	08f76163          	bltu	a4,a5,80200456 <interrupt_handler+0x8c>
    802003d8:	00001717          	auipc	a4,0x1
    802003dc:	b9870713          	addi	a4,a4,-1128 # 80200f70 <etext+0x540>
    ...
    802003ee:	b3650513          	addi	a0,a0,-1226 # 80200f20 <etext+0x4f0>
    802003f2:	b9a5                	j	8020006a <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003f4:	00001517          	auipc	a0,0x1
    802003f8:	b0c50513          	addi	a0,a0,-1268 # 80200f00 <etext+0x4d0>
    802003fc:	b1bd                	j	8020006a <cprintf>
            cprintf("User software interrupt\n");
    802003fe:	00001517          	auipc	a0,0x1
    80200402:	ac250513          	addi	a0,a0,-1342 # 80200ec0 <etext+0x490>
    80200406:	b195                	j	8020006a <cprintf>
            cprintf("Supervisor software interrupt\n");
    80200408:	00001517          	auipc	a0,0x1
    8020040c:	ad850513          	addi	a0,a0,-1320 # 80200ee0 <etext+0x4b0>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200418:	d55ff0ef          	jal	ra,8020016c <clock_set_next_event>
            ticks++;
    8020041c:	00004797          	auipc	a5,0x4
    80200420:	bf478793          	addi	a5,a5,-1036 # 80204010 <ticks>
    80200424:	6398                	ld	a4,0(a5)
            if (ticks >= 100) {
    80200426:	06300693          	li	a3,99
    8020042a:	00004417          	auipc	s0,0x4
    8020042e:	bee40413          	addi	s0,s0,-1042 # 80204018 <num>
            ticks++;
    80200432:	0705                	addi	a4,a4,1
    80200434:	e398                	sd	a4,0(a5)
            if (ticks >= 100) {
    80200436:	639c                	ld	a5,0(a5)
    80200438:	02f6e063          	bltu	a3,a5,80200458 <interrupt_handler+0x8e>
		cprintf("100 ticks\n");  
		num++;  
		ticks = 0; 
	    }
    ...
    8020043e:	47a5                	li	a5,9
    80200440:	02e7ea63          	bltu	a5,a4,80200474 <interrupt_handler+0xaa>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200444:	60a2                	ld	ra,8(sp)
    80200446:	6402                	ld	s0,0(sp)
    80200448:	0141                	addi	sp,sp,16
    8020044a:	8082                	ret
            cprintf("Supervisor external interrupt\n");
    8020044c:	00001517          	auipc	a0,0x1
    80200450:	b0450513          	addi	a0,a0,-1276 # 80200f50 <etext+0x520>
    80200454:	b919                	j	8020006a <cprintf>
            print_trapframe(tf);
    80200456:	bf11                	j	8020036a <print_trapframe>
		cprintf("100 ticks\n");  
    80200458:	00001517          	auipc	a0,0x1
    8020045c:	ae850513          	addi	a0,a0,-1304 # 80200f40 <etext+0x510>
    ...
    8020046e:	ba07b323          	sd	zero,-1114(a5) # 80204010 <ticks>
    80200472:	b7e9                	j	8020043c <interrupt_handler+0x72>
}
    80200474:	6402                	ld	s0,0(sp)
    80200476:	60a2                	ld	ra,8(sp)
    80200478:	0141                	addi	sp,sp,16
		sbi_shutdown(); 
    8020047a:	a3bd                	j	802009e8 <sbi_shutdown>
...
void exception_handler(struct trapframe *tf) {
    ...
    switch (tf->cause) {
    80200486:	470d                	li	a4,3
void exception_handler(struct trapframe *tf) {
    80200488:	842a                	mv	s0,a0
    switch (tf->cause) {
    8020048a:	04e78663          	beq	a5,a4,802004d6 <exception_handler+0x5a>
    8020048e:	02f76c63          	bltu	a4,a5,802004c6 <exception_handler+0x4a>
    80200492:	4709                	li	a4,2
    80200494:	02e79563          	bne	a5,a4,802004be <exception_handler+0x42>
             /* LAB1 CHALLENGE3   2211154 :  */
            /*(1)输出指令异常类型（ Illegal instruction）
             *(2)输出异常指令地址
             *(3)更新 tf->epc寄存器
            */
            cprintf("Illegal instruction caught at 0x%x\n", tf->epc);
    80200498:	10853583          	ld	a1,264(a0)
    8020049c:	00001517          	auipc	a0,0x1
    802004a0:	b0450513          	addi	a0,a0,-1276 # 80200fa0 <etext+0x570>
    802004a4:	bc7ff0ef          	jal	ra,8020006a <cprintf>
            cprintf("Exception type: Illegal instruction\n");
    802004a8:	00001517          	auipc	a0,0x1
    802004ac:	b2050513          	addi	a0,a0,-1248 # 80200fc8 <etext+0x598>
    802004b0:	bbbff0ef          	jal	ra,8020006a <cprintf>
            tf->epc += 4;
    802004b4:	10843783          	ld	a5,264(s0)
    802004b8:	0791                	addi	a5,a5,4
    802004ba:	10f43423          	sd	a5,264(s0)
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    802004c4:	8082                	ret
    switch (tf->cause) {
    802004c6:	17f1                	addi	a5,a5,-4
    802004c8:	471d                	li	a4,7
    802004ca:	fef77ae3          	bgeu	a4,a5,802004be <exception_handler+0x42>
}
    802004ce:	6402                	ld	s0,0(sp)
    802004d0:	60a2                	ld	ra,8(sp)
    802004d2:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004d4:	bd59                	j	8020036a <print_trapframe>
            cprintf("ebreak caught at 0x%x\n", tf->epc);
    802004d6:	10853583          	ld	a1,264(a0)
    802004da:	00001517          	auipc	a0,0x1
    802004de:	b1650513          	addi	a0,a0,-1258 # 80200ff0 <etext+0x5c0>
    802004e2:	b89ff0ef          	jal	ra,8020006a <cprintf>
            cprintf("Exception type: breakpoint\n");
    802004e6:	00001517          	auipc	a0,0x1
    802004ea:	b2250513          	addi	a0,a0,-1246 # 80201008 <etext+0x5d8>
...
0000000080200504 <trap>:

/* trap_dispatch - dispatch based on what type of trap occurred */
static inline void trap_dispatch(struct trapframe *tf) {
    if ((intptr_t)tf->cause < 0) {
    80200504:	11853783          	ld	a5,280(a0)
    80200508:	0007c363          	bltz	a5,8020050e <trap+0xa>
        // interrupts
        interrupt_handler(tf);
    } else {
        // exceptions
        exception_handler(tf);
    8020050c:	bf85                	j	8020047c <exception_handler>
        interrupt_handler(tf);
    8020050e:	bd75                	j	802003ca <interrupt_handler>
...
__alltraps:
    ...
    jal trap
    80200574:	f91ff0ef          	jal	ra,80200504 <trap>
